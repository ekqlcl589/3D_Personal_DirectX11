...
CPlayerRageEffect::CPlayerRageEffect(const CPlayerRageEffect & rhs)
	: CGameObject(rhs)
{
}

HRESULT CPlayerRageEffect::Initialize_Prototype()
{
...
HRESULT CPlayerRageEffect::Initialize(void * pArg)
{
...
HRESULT CPlayerRageEffect::Render()
{
...
HRESULT CPlayerRageEffect::Add_Components()
{
...
HRESULT CPlayerRageEffect::SetUp_ShaderResources()
{
...
CPlayerRageEffect * CPlayerRageEffect::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPlayerRageEffect*		pInstance = new CPlayerRageEffect(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CPlayerRageEffect");
...
CGameObject * CPlayerRageEffect::Clone(void * pArg)
{
	CPlayerRageEffect*		pInstance = new CPlayerRageEffect(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CPlayerRageEffect");
		Safe_Release(pInstance);
	}
