#include "stdafx.h"
#include "..\Public\LoadingImg.h"

#include "GameInstance.h"
CLoadingImg::CLoadingImg(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
...
HRESULT CLoadingImg::Initialize_Prototype()
{
...
HRESULT CLoadingImg::Initialize(void * pArg)
{
...
void CLoadingImg::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CLoadingImg::LateTick(_double TimeDelta)
{
...
HRESULT CLoadingImg::SetUp_ShaderResource()
{
...
CLoadingImg * CLoadingImg::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CLoadingImg*		pInstance = new CLoadingImg(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CLoadingImg");
...
CGameObject * CLoadingImg::Clone(void* pArg)
{
	...
	{
		MSG_BOX("Failed to Cloned : CLoadingImg");
		Safe_Release(pInstance);
	}
