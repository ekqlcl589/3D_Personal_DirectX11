...
namespace Engine
{
	...
	enum CHANNELID { SOUND_EFFECT, SOUND_BGM, SOUND_SKILL, SOUND_PLAYER, SOUND_MONSTER, SOUND_MONSTERHIT01, SOUND_MONSTERHIT02, SOUND_MONSTERHIT03, SOUND_EFFECTLEVELUP, SOUND_EFFECTQUEST, SOUND_BOSS_EFFECT, MAXCHANNEL };
