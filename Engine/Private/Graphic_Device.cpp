...
HRESULT CGraphic_Device::Present()
{
	...
	/* 전면 버퍼와 후면 버퍼를 교체하면서 후면 버퍼를 전면으로 보여줌*/
...
HRESULT CGraphic_Device::Ready_BackBufferRenderTargetView()
{
	...
	/* 앞으로 사용하기 위한 용도의 객체를 생성하기 위한 베이스 데이터를 가지고 있는 객체*/
	/* 사용하기위한 용도의 객체 : ID3D11RenderTargetView, ID3D11ShaderResoureView, ID3D11DepthStencilView */
	ID3D11Texture2D*		pBackBufferTexture = nullptr;

	/* 스왑체인이 가지고 있던 텍스처의 정보를 받아옴 */
