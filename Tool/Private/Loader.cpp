...
HRESULT CLoader::Loading_ForGamePlay()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_StaticMesh0"),
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_StaticMesh1"),
		CModel::Create(m_pDevice, m_pContext, "../Bin/Resources/Models/StaticMesh/Eltheca/Eltheca_ChaserHall_Floor1.fbx", CModel::MODEL_NONANIM, LocalMatrix))))
		return E_FAIL;

	if (FAILED(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_StaticMesh2"),
		CModel::Create(m_pDevice, m_pContext, "../Bin/Resources/Models/StaticMesh/Eltheca/Eltheca_ChaserHall_Floor2.fbx", CModel::MODEL_NONANIM, LocalMatrix))))
		return E_FAIL;

	if (FAILED(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_StaticMesh3"),
		CModel::Create(m_pDevice, m_pContext, "../Bin/Resources/Models/StaticMesh/Eltheca/Eltheca_Elscope_Circle_aa.fbx", CModel::MODEL_NONANIM, LocalMatrix))))
		return E_FAIL;
